...
const Timeline = () => {
  ...
  const timelineItems = [
    ...
    },
    {
      ...
      company: 'InnovateX',
      period: '2020 - 2023',
      description: 'Developed and maintained multiple web applications using React and Node.js. Implemented RESTful APIs and improved database performance by 30%.',
      icon: <FaBriefcase />,
    },
    {
      type: 'award',
      title: 'Best Developer Award',
      institution: 'Tech Excellence Awards',
      period: '2022',
  ...
  return (
    <div id="timeline" className="w-full min-h-screen bg-primary text-textPrimary">
      <div className="max-w-[1200px] mx-auto px-8 py-16">
        ...
        >
          <h2 className="text-4xl font-bold text-secondary mb-8">Professional Journey</h2>
