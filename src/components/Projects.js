  ...
  const projects = [
    {
      ...
      github: "https://github.com/Tademillion",
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {projects[currentProject].technologies.frontend.map(
                            (tech) => (
                              <span
                                key={tech}
                                className="px-3 py-1 bg-secondary/20 text-secondary rounded-full text-sm hover:bg-secondary/30 transition-colors duration-300"
                              >
                                {tech}
                              </span>
                            )
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {projects[currentProject].technologies.backend.map(
                            (tech) => (
                              <span
                                key={tech}
                                className="px-3 py-1 bg-secondary/20 text-secondary rounded-full text-sm hover:bg-secondary/30 transition-colors duration-300"
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {projects[currentProject].technologies.database.map(
                            (tech) => (
                              <span
                                key={tech}
                                className="px-3 py-1 bg-secondary/20 text-secondary rounded-full text-sm hover:bg-secondary/30 transition-colors duration-300"
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside text-textSecondary mt-2 space-y-1">
                          {projects[currentProject].technologies.features.map(
                            (feature) => (
                              <li
                                key={feature}
